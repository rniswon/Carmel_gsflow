...
FREE
OPEN/CLOSE   .\input\bas_support\Ibnd_1.txt          1   (FREE)    4     # IBOUND Array For LAYER 1
OPEN/CLOSE   .\input\bas_support\Ibnd_2.txt          1   (FREE)    4     # IBOUND Array For LAYER 2
OPEN/CLOSE   .\input\bas_support\Ibnd_3.txt          1   (FREE)    4     # IBOUND Array For LAYER 3
 -999.                                            HNOFLO 
EXTERNAL     59                   1 (BINARY)  -1 #SS HEADS FOR LAYER 1
