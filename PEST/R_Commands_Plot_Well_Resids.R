...
posterior <- read.table('D:/EDM_LT/GitHub/Carmel/PEST/Iteration_1_Back_From_Condor/OUTPUT/hobs.out',header=FALSE,skip=1,col.names=c('sim','obs','name'))

prior$resid <- prior$sim - prior$obs
posterior$resid <- posterior$sim - posterior$obs

png('D:/EDM_LT/GitHub/Carmel/PEST/well_resids.png', res=120, width=700, height=700)
